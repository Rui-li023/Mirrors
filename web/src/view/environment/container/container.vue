<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="镜像名称" prop="imageName">
         <el-input v-model="searchInfo.imageName" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="镜像名称" prop="imageName" width="240" />
        <el-table-column align="left" label="启动命令" prop="command" width="200" />
        <el-table-column align="left" label="创建时间" prop="create" width="220" />
        <el-table-column align="left" label="运行状态" prop="status" width="180" />
        <el-table-column align="left" label="端口" prop="ports" width="460" />
        <el-table-column align="left" label="操作" fixed="right" min-width="220">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateContainerFunc(scope.row)">变更</el-button>
...
const onDelete = async() => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    type: 'warning'
      ...
      const res = await deleteContainerByIds({ IDs })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
const deleteContainerFunc = async (row) => {
    const res = await deleteContainer({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
